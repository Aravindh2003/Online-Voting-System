    ...
    return (
      <div class="container-fluid bg-dark">
              <nav class="navbar navbar-expand-lg bg-dark navbar-dark text-white fixed-top" style={{paddingLeft: "5rem", paddingRight: "5rem"}}>
                  ...
                  <a href="/"><h1 class="fw-bold" style={{paddingLeft: "0.25rem", paddingRight: "1rem",color: "white"}}>Vote.me</h1> </a>
    ...
    return (
      <div class="container-fluid bg-dark">
              <nav class="navbar navbar-expand-lg bg-dark navbar-dark text-white fixed-top" style={{paddingLeft: "5rem", paddingRight: "5rem"}}>
                  ...
                  <a href="/dashboard"><h1 class="fw-bold" style={{paddingLeft: "0.25rem", color: "white"}}>Vote.me</h1> </a>
                  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span>
                  </button>
                  {/* <div class="collapse navbar-collapse" id="navbarSupportedContent" >
